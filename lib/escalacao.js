...
export function layoutAutomatico(jogadores) {
  ...
  // Só as linhas que existem ocupam o campo. Um elenco de meias e atacantes
  // sem goleiro não pode deixar a metade defensiva vazia, senão o campo fica
  // com cara de tela pela metade.
  const alturas = {};
