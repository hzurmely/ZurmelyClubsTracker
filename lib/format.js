...
/**
 * Cores de uniforme da EA vêm como inteiro decimal do RGB.
 * Ex.: 15921906 = 0xF2F2F2. O valor -1 significa "sem cor definida".
 */
...
/** Luminância relativa, para decidir entre texto claro e escuro sobre a cor. */
...
/**
 * A API da EA devolve texto UTF-8 rotulado como Latin-1, então nomes com acento
 * chegam como "JosÃ©" em vez de "José". Isto desfaz a bagunça quando detecta o
 * padrão, e devolve o original intacto quando não há nada a corrigir.
 * Também colapsa os espaços de enfeite que o jogo deixa nos nomes de clube.
 */
export function fixText(value) {
  ...
  if (/[ÃÂ][\x80-\xbf]/.test(s)) {
    try {
      ...
      /* não era mojibake, segue o original */
    }
  }
